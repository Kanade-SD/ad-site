<template>
  <el-dialog v-model="visible" title="添加横幅 (建议图片长宽比为8:1)" align-center @close="close">
...
import { apiAddAd, apiImgUpload } from "@/api/api";
import type { AdType } from "@/types/data";
import {
  ElMessage,
  type FormInstance,
  type UploadInstance,
...
const formData = ref<AdType & LinkType & FormFile>(defaultData());
