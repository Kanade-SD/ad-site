...
import { apiAddAdFloat, apiImgUpload } from "@/api/api";
import type { AdFloatType } from "@/types/data";
import {
  ElMessage,
  type FormInstance,
  type UploadInstance,
...
const defaultData = (): AdFloatType & LinkType & FormFile => ({
  id: "",
  type: "link",
  link: "",
  position: "left",
...
const formData = ref<AdFloatType & LinkType & FormFile>(defaultData());
...
const rules = {
  ...
  position: [{ required: true, message: "请选择悬浮位置", trigger: "blur" }],
  imgUrl: [
