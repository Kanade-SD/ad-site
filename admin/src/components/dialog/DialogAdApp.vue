...
import { apiAddAdApp, apiImgUpload } from "@/api/api";
import type { AdAppType } from "@/types/data";
import {
  ElMessage,
  type FormInstance,
  type UploadInstance,
...
const formData = ref<AdAppType & LinkType & FormFile>(defaultData());
